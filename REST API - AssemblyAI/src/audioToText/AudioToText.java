...
public class AudioToText {
	...
	public static void main(String[] args) throws URISyntaxException, IOException, InterruptedException {
		...
		transcript.setAudio("https://github.com/Jok98/FileAudio/blob/main/Registrazione.m4a?raw=true");
		...
		if("completed".equals(transcript.getStatus()) || "error".equals(transcript.getStatus()) || ApiKey.key.isEmpty()) break;
		Thread.sleep(1000);
